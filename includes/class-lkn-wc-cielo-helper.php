        ...
        if (! empty($id)) {
            ...
            if ($order && $order instanceof WC_Order) {
                ...
                if ($orderLogs && 'yes' === $options['show_order_logs']) {
                    //carregar css
                    wp_enqueue_style('lkn-wc-cielo-order-logs', LKN_WC_GATEWAY_CIELO_URL . 'admin/css/lkn-admin-order-logs.css', array(), LKN_WC_CIELO_VERSION, 'all');
...
<?php
    ...
    {
        return LKN_WC_GATEWAY_CIELO_URL . 'admin/images/icon.svg';
    }
}
