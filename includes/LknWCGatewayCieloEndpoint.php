...
final class LknWCGatewayCieloEndpoint {
    public function registerOrderCaptureEndPoint() {
    ...
    public function orderCapture($request) {
        ...
        $url = ($debitOption['env'] == 'production') ? 'https://apiquery.cieloecommerce.cielo.com.br/1/cardBin/' : 'https://apiquerysandbox.cieloecommerce.cielo.com.br/1/cardBin/';
        $url = $url . $cardBin;
