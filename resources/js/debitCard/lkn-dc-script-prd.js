...
function lknDCProccessButton () {
  ...
  const cardTypeSelect = document.querySelector('#wc-block-components-sort-select__select-0') || // Novo checkout em blocos
                        document.querySelector('.lkn-credit-debit-card-type-select select') || // Seletor por classe
